...
\begin{frame}
	...
	Statistics from $1000$ random realizations of phases $\boldsymbol{\Phi}$.
	\bigskip
...
\centering
\begin{figure}
\includegraphics[width= 8cm, height = 5cm]{attenuation}
\end{figure}
\end{column}
\begin{column}{0.5\linewidth}
\centering
\begin{figure}
\includegraphics[width= 8cm, height = 5cm]{los}
\end{figure}
\end{column}
\end{columns}
\end{frame}
