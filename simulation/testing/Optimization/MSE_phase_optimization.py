...
ave_plt.plot(rhos, cor_mf_mu, '-o', label='MF')
ave_plt.plot(rhos, cor_zf_mu, '-o', label='ZF')
var_plt.plot(rhos, cor_mf_var, '-o', label='MF')
var_plt.plot(rhos, cor_zf_var, '-o', label='ZF')
ave_plt.set_ylabel("Average MSE  (dB)")
var_plt.set_ylabel("Average MSE Variance (dB)")
ave_plt.set_yscale('log')
ave_plt.set_xlabel("rho")
var_plt.set_yscale('log')
var_plt.set_xlabel("rho")
